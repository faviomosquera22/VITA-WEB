...
export function getMspComplianceDashboard(): MspComplianceDashboard {
  ...
  const domains: MspDomainSnapshot[] = [
    ...
    },
    {
      ...
      status: "implementado",
      evidence: `El sistema registra consentimiento requerido, obtenido, rechazo, representante y testigo; ${consentRequired} casos lo marcaron como requerido y ya existe vista imprimible tipo formulario.`,
      riskIfMissing: "Riesgo medico-legal y nulidad de procedimientos invasivos o sensibles.",
      nextStep: "Persistir PDF firmado y agregar firma electronica/certificado en produccion.",
    },
    {
      code: "MSP-REF053",
      area: "Continuidad",
      ...
      status: "implementado",
      evidence: `El expediente ya contempla resumen clinico, hallazgos, tratamiento realizado y destino; ${referralsCompleted} referencias completas detectadas y con salida imprimible.`,
      riskIfMissing: "Perdida de continuidad entre niveles y errores en transferencias.",
      nextStep: "Persistir el formulario emitido y enlazar referencia/contrarreferencia con la red externa real.",
    },
    {
      code: "MSP-SIVE",
      area: "Salud publica",
    ...
    },
    {
      ...
      status: "parcial",
      evidence: "Ingreso ya captura solicitudes y justificacion clinica y ahora genera formularios imprimibles 010A/012A, pero no existe interoperabilidad real con LIS/RIS/PACS.",
